...
class CountryCode {
  ...
  dynamic PhonetoCountry({required String phonecode}) {
    Map countcod = countries.firstWhere(
        (element) => element["dial_code"] == phonecode,
        orElse: () => {"code": "Not Found"});

    if (countcod["code"] != "Not Found") {
      Country c = CountryParser.parseCountryCode(countcod["code"] as String);
      return c;
    } else {
      return 0;
    }
